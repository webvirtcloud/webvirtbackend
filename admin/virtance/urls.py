...
from .views import AdminVirtanceResetEventView, AdminVirtanceRecreateView
...
urlpatterns = [
    ...
    re_path(r"^(?P<pk>\d+)/recreate/$", AdminVirtanceRecreateView.as_view(), name="admin_virtance_recreate"),
